...
public class PopupShopView : PopupBase<List<PopupShopItemModel>,bool>
{
  [SerializeField]
  private ScrollRect scroll;
  [SerializeField]
  private PopupShopItemView BaseItem;
  [SerializeField]
  private float space;
  [SerializeField]
  ...
  public override void Initialize(List<PopupShopItemModel> data, TaskCompletionSource<bool> res)
  {
    ...
    for (int i = 0; i < data.Count; i++) 
    {
      ...
      var item = obj.GetComponent<PopupShopItemView>();
      item.Initialize();
