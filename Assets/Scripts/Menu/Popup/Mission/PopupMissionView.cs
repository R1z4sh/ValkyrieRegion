...
public class PopupMissionView : PopupBase<List<PopupMissionItemModel>,bool>
{
  [SerializeField]
  private ScrollRect scroll;
  [SerializeField]
  private PopupMissionItemView BaseItem;
  [SerializeField]
  private float space;
  [SerializeField]
  ...
  public override void Initialize(List<PopupMissionItemModel> data, TaskCompletionSource<bool> res)
  {
    ...
    for (int i = 0; i < data.Count; i++) 
    {
      ...
      var item = obj.GetComponent<PopupMissionItemView>();
      item.Initialize();
